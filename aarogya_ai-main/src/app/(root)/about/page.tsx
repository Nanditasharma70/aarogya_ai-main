          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {/* {teamMembers.map((member, index) => ( */}
                <div 
                // key={index} 
                className="flex flex-col items-center bg-gray-100 p-5 rounded-lg ">
                <img
                  src='nanditass.jpeg'
                  alt='nanditaimage'
                  className="w-80 h-80   rounded-full mb-4 object-cover"
                  width={200}
                  height={200}
                />
                <h3 className="text-xl font-semibold">Nandita Sharma
                  {/* {member.name} */}
                </h3>
